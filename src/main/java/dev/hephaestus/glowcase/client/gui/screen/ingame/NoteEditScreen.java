...
//	private List<Component> signingLines;
...
//
//					this.signingLines.add(text);
//				} else {
//					this.signingLines.add(Component.empty());
//				}
//			}
//		}
...
//		if (signing) signAndFinalizeButton.active = !title.isEmpty();
//
//		return result;
	}
